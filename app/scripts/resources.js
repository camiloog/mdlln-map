var r_data = {
  'NONE': [
    ...
    {'USAGE':'Use el la rueda del mouse o las teclas <span style="border: 1px solid;padding: 0 2px;border-radius: 2px;" title="Más">+</span> y <span style="border: 1px solid;padding: 0 3px;border-radius: 2px;" title="Menos">-</span> para hacer zoom en el mapa.','GIF':'./tutorial/zoom.gif'},
    ...
    {'USAGE':'Observe el cuadro de información en la vista de comuna o corregimiento. En este se muestran los iconos de los recursos con los que esta comuna tiene problematicas ambientales. De click en estos iconos para cambiar a la vista del recurso.','GIF':'./tutorial/informacion_comuna.gif'},
    {'USAGE':'Si necesita más espacio para visualizar el mapa, sobretodo al acceder desde un dispositivo mobil, puede colapsar las convenciones del mapa haciendo click sobre ellas. Haga click sobre el boton que aparece en su lugar para visualizarlas nuevamente.','GIF':'./tutorial/colapsar_leyendas.gif'},
    {'USAGE':'Regrese a este manual y limpie el mapa dando click en el boton Limpiar del menú principal.'}
  ],
  'REC_AGUA': [
  ...
  'REC_SUELO': [
    ...
    {'DESCRIPCIÓN':'Movimiento en masa en cerros tutelares.','FRASE_CORTA':'Movimiento en masa en cerros tutelares'}
  ],
  'SOCIOCULT': [
